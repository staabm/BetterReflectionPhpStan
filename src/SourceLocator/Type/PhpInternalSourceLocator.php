...
final class PhpInternalSourceLocator extends AbstractSourceLocator
{
    ...
    private function createLocatedSourceFromStubData(Identifier $identifier, ?\Roave\BetterReflection\SourceLocator\SourceStubber\StubData $stubData, ?string $aliasName = null): ?\Roave\BetterReflection\SourceLocator\Located\InternalLocatedSource
    {
        if ($stubData === null) {
            return null;
        }
